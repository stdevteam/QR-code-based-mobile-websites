...
class MailerComponent extends Object{
    ...
    public function userRegistrationEmail($data){
        ...
        $this->EmailService->from = 'Dog Vacay <noreply@vendingqr.com>';
        $this->EmailService->bcc = 'Concierge <concierge@vendingqr.com>';
        $this->EmailService->to = $name.' <'.$email.'>';
        $this->EmailService->sendAs = 'both';

        $this->EmailService->subject = 'You have just registered at vendingqr.com!';
    ...
    public function bookUserEmail($data){
        ...
        $this->EmailService->subject = 'Your booking information from vendingqr.com';    
    ...
    public function bookHostEmail($data){
        ...
        $this->EmailService->subject = 'Good News! Someone has booked your place at vendingqr.com';    
    ...
    public function sendEmail($to,$subject,$type,$details=null){
        ...
        $this->EmailService->to = 'Concierge Dog Vacay <concierge@vendingqr.com>';
        ...
        if(!isset($details)){
            ...
            $content = "New user registered on vendingqr.com<br />".
    ...
    public function startListingForUser($email,$place_id){
        ...
        $this->EmailService->subject = 'Take a sneak peek at your profile at vendingqr.com!';
    ...
    public function listingActivated($email,$place_id){
        $this->EmailService->from = 'Dog Vacay <noreply@vendingqr.com>';
        $this->EmailService->bcc = array('Concierge <concierge@vendingqr.com>'); #, 'partners@science-inc.com');
        $this->EmailService->to = $email;
        $this->EmailService->sendAs = 'html';

        $this->EmailService->subject = 'Your profile has been approved at vendingqr.com!';
    ...
    public function messageForApproved($email,$message,$place_id,$subject){
        ...
        $this->EmailService->subject = ($subject == 'approved')? 'Your profile has been approved at vendingqr.com!' :  'Your profile has been unapproved at vendingqr.com!';
    ...
    public function passwordRecovery($user){
        $this->EmailService->from = 'Concierge <concierge@vendingqr.com>';
        $this->EmailService->to = $user['User']['email'];
        $this->EmailService->sendAs = 'both';

        $this->EmailService->subject = 'Password recovery information for vendingqr.com';
    ...
    public function userConfirmEmail($data,$verify){
      ...
      //  $profile = $data['Profile'];
        ...
        $this->EmailService->from = 'Vendingqr <noreply@vendingqr.com>';
        $this->EmailService->bcc = 'Concierge <concierge@vendingqr.com>';
        $this->EmailService->to = $name.' <'.$email.'>';
        $this->EmailService->sendAs = 'both';

        $this->EmailService->subject = 'Please confirm your email address to activate your account at vendingqr.com';
    ...
    public function aboutPageEmail($email){
        $this->EmailService->from = 'Dog Vacay <noreply@vendingqr.com>';
        $this->EmailService->to = 'Concierge <concierge@vendingqr.com>';    
    ...
    public function meetAndGreetEmail($data,$toUser,$fromUser,$tId){
        ...
        $this->EmailService->subject = 'Request for Meet & Greet at vendingqr.com';
    ...
    public function sendReviewRequest($email,$senderName,$options,$url){
        ...
        $this->EmailService->bcc = 'Concierge <concierge@vendingqr.com>';
        $this->EmailService->to = '<'.$email.'>';
        $this->EmailService->subject = 'Invitation to review '.$senderName.' on vendingqr.com';
    ...
    */
    ...
    public function firstMessageForHost($email){
        ...
        $this->EmailService->subject = 'You have first message at vendingqr.com!';
