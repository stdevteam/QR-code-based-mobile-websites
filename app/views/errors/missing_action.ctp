...
<body>
    <div class="frame">
        <div class="error">
            ...
            <ul>
                <li>Did you mean to type <a href="<?php echo FULL_BASE_URL; ?>"><u>dogvacay.com?</u></a></li> 
                <li>Do you want to search for <a href="/places/"><u>boarding</u></a> or <a href="/contents/about/"><u>other services?</u></a></li>
                <li><a href="/contents/contact/"><u>Contact us</u></a> to let us know what you think</li>
            </ul>
            <h2>Your friends at <a href="<?php echo FULL_BASE_URL; ?>">dogvacay.com</a></h2>
        </div>
    </div>
</body>
</html>
