...
if (FALSE !== stripos($_SERVER['DOCUMENT_ROOT'], '/beta')) {
    Configure::write('debug', 2);
}
if (FALSE !== stripos($_SERVER['DOCUMENT_ROOT'], '/xampp')) {
    Configure::write('debug', 2);
}
 ...
 *
 */
	Configure::write('Session.save', 'myhandler');
 ...
 */
	Configure::write('Security.salt', 'EYhG93b0qyJfIxfs3guVoUubWwvniR2G0FgaC9mj');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '86859309657453842496749683646');
